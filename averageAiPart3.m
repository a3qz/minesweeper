...
function move = averageAiPart3(nRow, nCol, cover)
            ...
            if (cover(iRow, iCol) > 0) && (cover(iRow, iCol) <11)
                if iRow == 1
                    ...
                    elseif iCol == nCol
                        ...
                        if (checkDL(iRow, iCol, cover) == 11) || (checkDL(iRow, iCol, cover) == 99)
                            numTouchingSquares = numTouchingSquares + 1;
                            touchingSquareRow = DL(2);
                            touchingSquareCol = DL(3);
                        end
                        if (checkLL(iRow, iCol, cover) == 11) || (checkLL(iRow, iCol, cover) == 99)
                            numTouchingSquares = numTouchingSquares + 1;
